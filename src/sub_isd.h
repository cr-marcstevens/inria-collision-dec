...
void sub_isd_init(word* simple_HprimemodT, unsigned int N, word* syndprime, unsigned int local_n, unsigned int local_r, unsigned int local_l, unsigned int local_l2, unsigned int local_l3, unsigned int local_p, unsigned int local_e1, unsigned int local_e2, unsigned int local_w, unsigned int local_threshold, sw_list** h);
void sub_isd();
